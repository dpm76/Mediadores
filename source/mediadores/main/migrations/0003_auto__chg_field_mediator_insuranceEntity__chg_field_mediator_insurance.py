...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mediator.insuranceEntity'
        db.alter_column('main_mediator', 'insuranceEntity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.InsuranceEntity'], null=True))

        # Changing field 'Mediator.insuranceContract'
        db.alter_column('main_mediator', 'insuranceContract', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Adding unique constraint on 'Mediator', fields ['nif']
        db.create_unique('main_mediator', ['nif'])

        # Changing field 'Mediator.insuranceExpiration'
        db.alter_column('main_mediator', 'insuranceExpiration', self.gf('django.db.models.fields.DateField')(null=True))

        # Adding index on 'Request', fields ['requester_nif']
        db.create_index('main_request', ['requester_nif'])


    def backwards(self, orm):
        
        # Removing index on 'Request', fields ['requester_nif']
        db.delete_index('main_request', ['requester_nif'])

        # Removing unique constraint on 'Mediator', fields ['nif']
        db.delete_unique('main_mediator', ['nif'])

        # Changing field 'Mediator.insuranceEntity'
        db.alter_column('main_mediator', 'insuranceEntity_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.InsuranceEntity']))

        # Changing field 'Mediator.insuranceContract'
        db.alter_column('main_mediator', 'insuranceContract', self.gf('django.db.models.fields.CharField')(default='', max_length=32))

        # Changing field 'Mediator.insuranceExpiration'
        db.alter_column('main_mediator', 'insuranceExpiration', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 12, 27)))
