...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Request.amount'
        db.add_column('main_request', 'amount', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Request.amount'
        db.delete_column('main_request', 'amount')
