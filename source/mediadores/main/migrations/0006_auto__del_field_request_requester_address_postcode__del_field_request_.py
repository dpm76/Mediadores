...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Request.requester_address_postalcode'
        db.add_column('main_request', 'requester_address_postalcode', self.gf('django.db.models.fields.CharField')(default='NA', max_length=8), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Request.requester_address_postalcode'
        db.delete_column('main_request', 'requester_address_postalcode')
