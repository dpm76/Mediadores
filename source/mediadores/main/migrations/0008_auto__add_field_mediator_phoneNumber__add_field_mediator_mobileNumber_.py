...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mediator.phoneNumber'
        db.add_column('main_mediator', 'phoneNumber', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Adding field 'Mediator.mobileNumber'
        db.add_column('main_mediator', 'mobileNumber', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Adding field 'Mediator.faxNumber'
        db.add_column('main_mediator', 'faxNumber', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Mediator.phoneNumber'
        db.delete_column('main_mediator', 'phoneNumber')

        # Deleting field 'Mediator.mobileNumber'
        db.delete_column('main_mediator', 'mobileNumber')

        # Deleting field 'Mediator.faxNumber'
        db.delete_column('main_mediator', 'faxNumber')
