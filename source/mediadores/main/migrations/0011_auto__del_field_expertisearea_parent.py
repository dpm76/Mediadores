...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExpertiseArea.parent'
        db.delete_column('main_expertisearea', 'parent_id')


    def backwards(self, orm):
        
        # Adding field 'ExpertiseArea.parent'
        db.add_column('main_expertisearea', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.ExpertiseArea'], null=True, blank=True), keep_default=False)
