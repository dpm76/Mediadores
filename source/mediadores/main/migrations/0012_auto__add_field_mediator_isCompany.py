...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mediator.isCompany'
        db.add_column('main_mediator', 'isCompany', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Mediator.isCompany'
        db.delete_column('main_mediator', 'isCompany')
