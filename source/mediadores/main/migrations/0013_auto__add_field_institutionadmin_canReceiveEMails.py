...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstitutionAdmin.canReceiveEMails'
        db.add_column('main_institutionadmin', 'canReceiveEMails', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstitutionAdmin.canReceiveEMails'
        db.delete_column('main_institutionadmin', 'canReceiveEMails')
