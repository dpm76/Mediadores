...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.contactEMail'
        db.add_column('main_institution', 'contactEMail', self.gf('django.db.models.fields.EmailField')(default='none@none.falso', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Institution.contactEMail'
        db.delete_column('main_institution', 'contactEMail')
