...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

        # Adding field 'Institution.phone'
        db.add_column('main_institution', 'phone', self.gf('django.db.models.fields.CharField')(default='-', max_length=16), keep_default=False)

        # Adding field 'Institution.fax'
        db.add_column('main_institution', 'fax', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Adding field 'Institution.mapIframe'
        db.add_column('main_institution', 'mapIframe', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Institution.phone'
        db.delete_column('main_institution', 'phone')

        # Deleting field 'Institution.fax'
        db.delete_column('main_institution', 'fax')

        # Deleting field 'Institution.mapIframe'
        db.delete_column('main_institution', 'mapIframe')
    ...
    models = {
        ...
        'main.institution': {
            ...
            'mapIframe': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'phone': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '16'}),
        ...
        'main.institutionadmin': {
            ...
            'canReceiveEMails': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'main.mediator': {
            ...
            'isCompany': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
