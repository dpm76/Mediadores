...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.mapX'
        db.add_column('main_institution', 'mapX', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Institution.mapY'
        db.add_column('main_institution', 'mapY', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Request.requester_email'
        db.alter_column('main_request', 'requester_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=64))


    def backwards(self, orm):
        
        # Deleting field 'Institution.mapX'
        db.delete_column('main_institution', 'mapX')

        # Deleting field 'Institution.mapY'
        db.delete_column('main_institution', 'mapY')
    ...
    models = {
        ...
        'main.institution': {
            ...
            'mapX': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'mapY': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
